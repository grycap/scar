...
class Udocker():
    ...
    def __init__(self, aws_properties, function_tmp_folder):
        ...
        self.udocker_install_dir = FileUtils.join_paths(self.function_tmp_folder, "udocker")
        self._initialize_udocker()

    def _initialize_udocker(self):
        self.udocker_code = FileUtils.join_paths(self.udocker_install_dir, "udocker.py")
    ...
    def save_tmp_udocker_env(self):
        ...
        if SysUtils.is_variable_in_environment("UDOCKER_DIR"):
            self.env_udocker_dir = SysUtils.get_environment_variable("UDOCKER_DIR")
        # Set temporal global vars
        SysUtils.set_environment_variable("UDOCKER_DIR", self.udocker_install_dir)
